...
bool nr_update_sib19(const gnb_sat_position_update_t *sat_position)
{
  ...
  LOG_D(NR_MAC, "TA_CommonDrift: value %d, = %lf µsec/sec\n", sat_position->drift, sat_position->drift * 0.2e-3);
  LOG_D(NR_MAC, "TA_CommonDriftVariant: value %d, %lf µsec/sec^2\n", sat_position->accel, sat_position->accel * 0.2e-4);
  LOG_D(NR_MAC, "posX: value %d, %.3lf metres\n", sat_position->posX, sat_position->posX * 1.3);
  LOG_D(NR_MAC, "posY: value %d, %.3lf metres\n", sat_position->posY, sat_position->posY * 1.3);
  LOG_D(NR_MAC, "posZ: value %d, %.3lf metres\n", sat_position->posZ, sat_position->posZ * 1.3);
  LOG_D(NR_MAC, "velX: value %d, %.3lf m/s\n", sat_position->velX, sat_position->velX * 0.06);
  LOG_D(NR_MAC, "velY: value %d, %.3lf m/s\n", sat_position->velY, sat_position->velY * 0.06);
  LOG_D(NR_MAC, "velZ: value %d, %.3lf m/s\n", sat_position->velZ, sat_position->velZ * 0.06);
  ...
  sib19_PosVel->positionX_r17 = sat_position->posX;
  sib19_PosVel->positionY_r17 = sat_position->posY;
  sib19_PosVel->positionZ_r17 = sat_position->posZ;
  sib19_PosVel->velocityVX_r17 = sat_position->velX;
  sib19_PosVel->velocityVY_r17 = sat_position->velY;
  sib19_PosVel->velocityVZ_r17 = sat_position->velZ;
